...
import {LOGINFAILED,LOGGEDIN, LOGGEDOUT, SIGNUP,ALLOFFERS, EDITITEM, STOCK, ADDFORSALE,UPDATEDATA,ADDBALANCE} from "./actionTypes";
...
export function addBalanceAction() {return{type:ADDBALANCE}};
