...
import {loadedAction, mainAction, loadingAction} from '../actions/actions.js';
import {
    Alert,
    Card,
    Button,
        ...
        usersToRender.push(<div style={{
            ...
            <Card style={{
                ...
                <CardBody>
                    ...
                    <div>
                        <div>
                            <Button color="primary" onClick={goToProfile()}>Got to profile</Button>
                        </div>
                        <br/>
...
const mapStateToProps = (state) => ({loadState: state.loadReducer.loadState, role: state.loginReducer.role, token: state.loginReducer.token});
