...
const SellItem = ({
    ...
    const [titleOK, setTitleOk] = React.useState(
        item
        ? true
        : false);
    const [descOK, setDescOk] = React.useState(
        item
        ? true
        : false);
    const [priceOK, setPriceOk] = React.useState(
        item
        ? true
        : false);
        ...
        <Form >
            {
                (() => {
                    if (page === 'EDITITEM') {
                        return (<div>
                            <h2 className="display-4">Edit offer</h2>
                            <hr className="my-2"/></div>)
                    } else if (page === 'ADDFORSALE') {
                        return (<div>
                            <h2 className="display-4">Add to sales</h2>
                            <hr className="my-2"/></div>)
                    } else {
                        return (<div>
                            <h2 className="display-4">Make a new offer</h2>
                            <hr className="my-2"/></div>)
                    }
                })()
            }
